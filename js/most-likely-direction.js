  ...
  cards.push('<div style="background:var(--bg1);border:0.5px solid var(--border);border-radius:8px;padding:10px 12px;">'
    ...
    +'<div style="display:grid;grid-template-columns:minmax(96px,1fr) 86px auto;gap:6px;align-items:end;">'
      +'<label style="font-size:9px;color:var(--text-faint);letter-spacing:.04em;text-transform:uppercase;">Type'
        +'<select id="mldManualClusterType" name="mld-liquidity-cluster-type" autocomplete="off" data-lpignore="true" data-1p-ignore="true" data-form-type="other" style="width:100%;margin-top:3px;background:var(--bg2);border:0.5px solid var(--border);border-radius:6px;color:var(--text);padding:5px 7px;font-size:10px;">'
      ...
      +'<label style="font-size:9px;color:var(--text-faint);letter-spacing:.04em;text-transform:uppercase;">Price'
        +'<input id="mldManualClusterPrice" name="mld-liquidity-cluster-price" type="number" step="0.1" inputmode="decimal" autocomplete="off" autocorrect="off" spellcheck="false" data-lpignore="true" data-1p-ignore="true" data-form-type="other" placeholder="63250" style="width:100%;margin-top:3px;background:var(--bg2);border:0.5px solid var(--border);border-radius:6px;color:var(--text);padding:5px 7px;font-size:10px;box-sizing:border-box;">'
      +'</label>'
      +'<button type="button" onclick="mldAddManualCluster()" style="background:var(--teal);color:var(--bg);border:none;border-radius:6px;padding:6px 10px;font-size:10px;font-weight:600;cursor:pointer;">Add</button>'
    +'</div>'
